...
public class MobArenaWitherSkeleton extends MobArenaWalkingMonster implements EntitySmite {
    ...
    public MobArenaWitherSkeleton(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
