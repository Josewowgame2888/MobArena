...
public class MobArenaMobArenaZombiePigman extends MobArenaWalkingMonster implements EntitySmite {
    public static final int NETWORK_ID = 36;

    private int angry = 0;

    public MobArenaMobArenaZombiePigman(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
