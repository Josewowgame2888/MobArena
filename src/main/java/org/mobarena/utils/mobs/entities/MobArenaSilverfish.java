...
public class MobArenaSilverfish extends MobArenaWalkingMonster implements EntityArthropod {
    public static final int NETWORK_ID = 39;

    public MobArenaSilverfish(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
