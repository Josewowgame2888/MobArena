...
public abstract class MobArenaWalkingEntity extends MobArenaBaseMob {
    protected RouteFinder route = null;

    public MobArenaWalkingEntity(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
    ...
    protected void checkTarget() {
        ...
        for (Entity entity : this.getLevel().getEntities()) {
            ...
            if (creature instanceof MobArenaBaseMob && ((MobArenaBaseMob) creature).isFriendly() == this.isFriendly()) {
                continue;
            }
