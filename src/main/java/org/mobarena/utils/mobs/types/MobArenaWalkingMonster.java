...
import org.mobarena.utils.mobs.MobArenaMonster;
import org.mobarena.utils.mobs.MobArenaWalkingEntity;

public abstract class MobArenaWalkingMonster extends MobArenaWalkingEntity implements MobArenaMonster {
    ...
    public MobArenaWalkingMonster(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
